...
if __name__ == '__main__':
    ...
    b, alphas = smoP(np.concatenate([sample1,sample2]).tolist(), np.concatenate([tag1,tag2]).tolist(), 0.1, 0.001, 1000)
    w = calcWs(alphas, np.concatenate([sample1,sample2]).tolist(), np.concatenate([tag1,tag2]).tolist())
    showClassifer(np.concatenate([sample1,sample2]).tolist(), np.concatenate([tag1,tag2]).tolist(), w, b)